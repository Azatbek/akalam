      ...
      <div class="inspace-30 row3">
        ...
        {!! Form::open(['url' => '/'.app()->getLocale().'/lyrics/store', 'name' => 'sendForm']) !!}
            <fieldset>
              ...
              <br/>
              {!! Form::select('category_id', App\Models\Category::where('parent_id', 12)->where('id', '!=', 20)->pluck('name', 'id'), null, ['placeholder' => trans('default.form.category'), 'class' => 'form-control', 'required']) !!}
              <br/>
